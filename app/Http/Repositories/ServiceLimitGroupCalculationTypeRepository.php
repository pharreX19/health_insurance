...
class ServiceLimitGroupCalculationTypeRepository extends BaseRepository
{

    public function __construct()
    {
        $this->model = ServiceLimitGroupCalculationType::class;
        $this->allowedIncludes = ['planService'];
